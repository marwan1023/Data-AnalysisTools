...
import numpy
import pandas
import statsmodels.formula.api as smft
...
model1 = smft.ols(formula='NUMCIGMO_EST ~ C(MAJORDEPLIFE)', data=sub1)
results1 = model1.fit()
...
model2 = smft.ols(formula='NUMCIGMO_EST ~ C(ETHRACE2A)', data=sub3).fit()
